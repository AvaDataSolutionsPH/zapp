          ...
          <div ref={userMenuRef} className="relative">
            ...
            {userMenuOpen && (
              <div className="absolute right-0 mt-1.5 w-48 bg-white rounded-xl shadow-lg border border-gray-200 py-1.5 z-50">
                {/* Points at /profile, a real page for every role. It used to
                    navigate to /settings — not a profile, and owner-only once
                    that was locked down, which bounced everyone else to the
